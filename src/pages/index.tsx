...
import { INTOUCH_DASHBOARD_USER } from "../constant/constant";
		...
		<>
			...
			<main>
				<div className="w-full h-screen flex flex-col items-center justify-center">
					<h1 className="text-4xl font-poppins font-light">THE ARK</h1>
					...
					<form onSubmit={handleSubmit(onSubmitHandler)} className="space-y-4">
						...
						<div className="pt-4">
							<button
								type="submit"
								className="w-full inline-flex justify-center py-3 px-4 border border-transparent shadow-sm text-sm font-medium  text-gray-800 rounded-md text-white hover:bg-navy-blue bg-navy-blue/90"
							>
								LOGIN
							</button>
						</div>
